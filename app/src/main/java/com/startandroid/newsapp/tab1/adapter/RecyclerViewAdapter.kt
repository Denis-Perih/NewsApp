package com.startandroid.newsapp.tab1.adapter
...
class RecyclerViewAdapter(private val blockNewsData: List<NewsItem>): RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v: View = LayoutInflater.from(parent.context).inflate(R.layout.item_tab_1_2, parent, false)
        return ViewHolder(v)
    }
